...
# === ТЕКСТЫ ===
WELCOME = (
    "Здравствуйте, это команда проекта «Цифровая исповедь» \n\n"
    "Мы собираем личные истории людей со всей России. Каждая история становится монологом цифрового аватара - лица и имени участника никто не узнает.\n\n" 
