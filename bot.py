...
WELCOME = (
    "👋 Здравствуйте.\n\n"
    "Это бот документального фильма <b>«Цифровая исповедь»</b> "
    "— студия 1147 Продакшнс.\n\n"
    "Мы собираем личные истории людей со всей России. Каждая история становится "
    "монологом цифрового аватара — лица, голоса и имени участника никто не узнаёт.\n\n"
    "Анкета займёт 3–5 минут. В любой момент можно остановиться — напишите /cancel.\n\n"
    "Готовы начать?"
)
